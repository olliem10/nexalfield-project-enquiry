...
import { HttpError, optionalEnv } from './http.ts'
import { readCookie, readSessionCookieValue, SESSION_COOKIE, unauthorized } from './session.ts'
...
export function notConfigured(): HttpError {
  return new HttpError(
    503,
    'not_configured',
    'No dashboard administrator has been set up yet. Set ADMIN_EMAIL and ADMIN_PASSWORD_HASH in your Netlify environment variables.',
  )
}
